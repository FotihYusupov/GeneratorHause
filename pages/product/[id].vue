    ...
    <div class="container">
        <div v-if="findProduct.product_title" class="product">
            <div v-if="findProduct.product_img" class="images-wrapper">
                <div class="images-list">
                    <img @click="getImg" class="list-item__img" v-for="(img, index) in findProduct.product_img" :src="img" alt="Product Img" :id="index">
                </div>
                ...
                <button @click="beforeImg" class="img-pagination-btn-start">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                        <g clip-path="url(#clip0_844_136)">
                            <path d="M24 48C37.234 48 48 37.234 48 24C48 10.766 37.234 0 24 0C10.766 0 0 10.766 0 24C0 37.234 10.766 48 24 48ZM16.586 22.586L26.586 12.586C26.976 12.196 27.488 12 28 12C28.512 12 29.0241 12.196 29.4141 12.586C30.196 13.368 30.196 14.632 29.4141 15.414L20.828 24L29.414 32.586C30.1959 33.368 30.1959 34.632 29.414 35.414C28.632 36.1959 27.368 36.1959 26.586 35.414L16.586 25.4139C15.804 24.632 15.804 23.368 16.586 22.586Z" fill="#7e7e7eab"/>
                        </g>
                        <defs>
            ...
            <div class="product-content">
                <div class="product__header">
                    ...
                    <span @click="favorites" v-if="!findProduct.inFavorites" id="addFavorites" class="product__favorites-wrapper">
                        ...
                        <p class="pointer-events">Favorites</p>
                    </span>
                    <span @click="favorites" v-else class="product__favorites-wrapper" id="removeFavorites">
                        <svg class="pointer-events" xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                            <path d="M10.516 17.8417C10.2327 17.9417 9.76602 17.9417 9.48268 17.8417C7.06602 17.0167 1.66602 13.575 1.66602 7.74168C1.66602 5.16668 3.74102 3.08334 6.29935 3.08334C7.81602 3.08334 9.15768 3.81668 9.99935 4.95001C10.841 3.81668 12.191 3.08334 13.6994 3.08334C16.2577 3.08334 18.3327 5.16668 18.3327 7.74168C18.3327 13.575 12.9327 17.0167 10.516 17.8417Z" fill="#FFD60A" stroke="#FFD60A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <p class="pointer-events">Favorites</p>
                    </span>
                </div>
                ...
                <p class="product__price" v-if="!findProduct.new_price">{{ findProduct.product_price * (findProduct.count || 1) }} So'm</p>
                <span class="product__basked-wrapper">
                    <button @click="addBasked" :disabled="findProduct.inCart">Add to Basked</button>
        ...
        <div class="product-details">
            ...
            <div class="product-details__wrapper">
                <span v-for="information in findProduct.information">
                    <p>{{ information.key }}</p>
                    <hr>
