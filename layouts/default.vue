          ...
          <div class="header__wrapper">
            ...
            <div class="header__category-btn-wrapper" id="btnWrapper">
              <button
                ...
                class="header__category-wrapper"
                id="openCategories"
              >
                <svg
              ...
              <div class="header__categories-wrapper">
                <div class="header__categories">
                  <NuxtLink
                    class="header__categories-link"
                    :to="'/category/657aef6f7633bfd3cdb02765'"
                    >Karcher stabilizator</NuxtLink
                  >
                  <NuxtLink
                    class="header__categories-link"
                    :to="'/category/657aef9a7633bfd3cdb02766'"
                    >Motokultivator
                  </NuxtLink>
                  <NuxtLink
                    class="header__categories-link"
                    :to="'/category/657aefb47633bfd3cdb02767'"
                    >Betona meshalka
                  </NuxtLink>
                  <NuxtLink
                    class="header__categories-link"
                    :to="'/category/657aefcd7633bfd3cdb02768'"
                    >Invertor Generator
                  </NuxtLink>
                  <NuxtLink
                    class="header__categories-link"
                    :to="'/category/657aefe47633bfd3cdb02769'"
                    >Benzinli generator
                  </NuxtLink>
                  <NuxtLink
                    class="header__categories-link"
                    :to="'/category/657aeff97633bfd3cdb0276a'"
                    >Dizelni generator
                  </NuxtLink>
                  <NuxtLink
                    class="header__categories-link"
                    :to="'/category/657af00c7633bfd3cdb0276b'"
                    >Gazvi generator
                  </NuxtLink>
                </div>
              </div>
            ...
            <div class="header__storage-wrapper">
              ...
              <div class="header__basked-wrapper" id="headerStore">
                ...
                <div
                  v-if="counterStore.data.basked > 0"
                  class="header__store-products"
                >
                  <ul class="header__store-products-list">
                    <li
                      class="header__store-item"
                      v-for="product in productsStore.data.products
                    ...
                    >
                      ...
                      <button
                        @click="removeBasked"
                        class="header__store-item-delete"
                      >
                        <svg
                          class="pointer-events"
                          xmlns="http://www.w3.org/2000/svg"
                          ...
                          <defs>
                            <clipPath id="clip0_502_10609">
                              <rect
                                ...
                                height="20"
                                fill="white"
                                transform="translate(0.667969 0.492065)"
                              />
                            </clipPath>
                          </defs>
                        </svg>
                  ...
                  <NuxtLink class="header__store-products-btn" to="/basked"
                    >Buy Now</NuxtLink
                  >
                </div>
              </div>
          ...
          <div class="footer__contact-wrapper">
            ...
            <span class="footer__contact">
              ...
              <a
                class="footer__contact-link"
                targetr="_blank"
                href="mailto:Generatorhouse@gmail.com"
                >Generatorhouse@gmail.com</a
              >
            </span>
            <span class="footer__contact">
              <svg
              ...
              <a
                class="footer__contact-link"
                target="_blank"
                href="https://maps.app.goo.gl/gZYbQJWEhLAwo4kH8"
                >Toshkent Xalqa Avtomabil Yo'li</a
              >
            </span>
            ...
            <div class="footer__messengers-wrapper">
              <a
                ...
                href="https://www.instagram.com/generator_house555/"
                target="_blank"
              ...
              <a
                class="footer__messenger"
                href="https://t.me/Jasur_generator555"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
